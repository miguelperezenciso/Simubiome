...
# ARGS are h2, b2, Nqtl_y, Notu_y, Notu_y_g
...
#------------------------------------------------------------------------
doBayesC = function(y,X=NULL,B=NULL,p0=5,pi1=0.001,pi2=0.001,out='bayc_') {
#------------------------------------------------------------------------
# perform Bayes C
...
b2 = 0.25
Nqtlotu_y = 100
Nqtl_y = as.integer(Nqtlotu_y / 2)
Notu_y = Nqtlotu_y - Nqtl_y
Notu_y_g = as.integer(Notu_y / 2)
Notu_y_g=0
Nqtl_otu = 10
Nclust = 500
Nmiss = 75
...
b2 = as.numeric(args[2])
Nqtl_y = as.numeric(args[3])
Notu_y = as.numeric(args[4])
Notu_y_g = as.numeric(args[5])
